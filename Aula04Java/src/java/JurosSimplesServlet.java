...
public class JurosSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Calcule aqui o Juros Simples</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Faça o Juros Simples</h1>");
            ...
            double calculo = value*(1+(vt_juros/100)*time); //fazendo uma variável pro cálculo// 
            out.println("<hr/><h2>R$ "+new DecimalFormat( "#,###,###,##0.00" ).format(calculo)+"</h2>"); //forma de formatar o valor decimal e não gerar muitas casas decimais
